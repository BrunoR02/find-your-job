  ...
  return (
    <section className={styles.content}>
      <p className={styles.text}>
        ...
        {` é um projeto de site com o objetivo especial de ajudar as pessoas a encontrar empregos. Possui implementações funcionais e completas, dentre elas:
  ...
  • Desenvolvimento do projeto usando Typescript, auxiliando na construção dos códigos complexos como também na produtividade.
      ...
      <span className={styles.contact}>
        ...
        <div className={styles.links}>
          <Link href="https://www.linkedin.com/in/bruno-ribeiro02/"><a className={styles.link} target="_blank"><Image src="https://find-your-job.s3.sa-east-1.amazonaws.com/icons/linkedin-icon.png" alt="linkedin" width="100%" height="100%"/></a></Link>
          <Link href="https://github.com/BrunoR02/find-your-job"><a className={styles.link} target="_blank"><Image src="https://find-your-job.s3.sa-east-1.amazonaws.com/icons/github-icon.png" alt="github" width="100%" height="100%"/></a></Link>
        </div>
      </span>
    </section>
  )
